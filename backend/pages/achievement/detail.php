            ...
            <div class="card-body">
                ...
                <form action="../../action/achievement/update.php?id=<?= $achievement->id?>" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="titleInput" placeholder="Masukan Kode Pos..." required value="<?=$achievement->title?>" disabled>
                    </div>
                    
                    <div class="mb-3">
                        <label for="descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="description" id="description" class="form-control" disabled placeholder="Masukan alamat..." rows="5"><?=$achievement->description?></textarea>
                    </div>
