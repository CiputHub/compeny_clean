            ...
            <div class="card-body">
                ...
                <form action="../../action/headmasters/update.php?id=<?= $headmasters->id?>" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="headmaster_name" class="form-control" id="headmaster_nameInput" placeholder="Masukan Nama..." required value="<?=$headmasters->headmaster_name?>">
                    </div>
                    <div class="mb-3">
                        <img class="w-25" src="../../../storages/headmasters/<?=$headmasters->headmaster_photo?>" alt="headmaster_photo">
                        <label for="headmaster_photoInput" class="form-label"></label>
                        <input type="file" name="headmaster_photo" class="form-control" id="headmaster_photoInput"></input>
                    </div>
                    
                    <div class="mb-3">
                        <label for="headmaster_descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="headmaster_description" id="headmaster_description" class="form-control" placeholder="Masukan Deskripsi..." rows="15"><?=$headmasters->headmaster_description?></textarea>
                    </div>
