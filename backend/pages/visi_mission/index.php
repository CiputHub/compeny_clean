...
$activePage = 'visi_mission';
include '../../partials/header.php';
include '../../partials/sidebar.php';
include '../../partials/navbar.php';

$qvisi_mission = "SELECT * FROM visi_missions";
$result = mysqli_query($connect, $qvisi_mission) or die(mysqli_error($connect));
                    ...
                    <div class="container-fluid px-4 mt-5">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-item-center justify-content-between">
                                <h5 class="mt-2">Tabel Visi Misi</h5>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                   <td><?= $no?></td>
                                    ...
                                    <td class="text-uppercase" ><?= mb_strimwidth($item->text, 0, 50, "...") ?></td>
                            ...
                            <a href="../../action/visi_mission/delete.php?id=<?= $item->id ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')">Hapus</a>
                        <?php endif; ?>
                                    </td>
                                </tr>
                           <?php
