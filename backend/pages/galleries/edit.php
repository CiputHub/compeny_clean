...
<!-- contect -->
  <div id="layoutSidenav_description">
 <div class="row px-5 mt-5  justify-description-center">
    <div class="col-9">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="../../action/galleries/update.php?id=<?= $galleries->id?>" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="titleInput" placeholder="Masukan judul..." required value="<?=$galleries->title?>"></input>
                    </div>
                    
                    <!-- <div class="mb-3">
                        <label for="descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="description" id="description" class="form-control" placeholder="Masukan Deskripsi..." rows="5"><?=$galleries->description?></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="dateInput" class="form-label">Tanggal</label>
                        <input type="date" name="date" class="form-control" id="dateInput" required value="<?=$galleries->date?>">
                    </div>
                     -->
