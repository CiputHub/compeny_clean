                    ...
                    <div class="container-fluid px-4 mt-5">
                            ...
                            <div class="card-body">
                                 <!-- <form method="GET" class="mb-3 d-flex">
                                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" 
                                        class="form-control me-2" placeholder="Cari deskripsi...">
                        ...
                        <tbody>
                         ...
                         if (mysqli_num_rows($result) > 0):
                            ...
                            ?>
                                <tr>
                                   <td><?= $no++?></td>
                                    ...
                                    <td>
                                       <img src="../../../storages/galleries/<?=$item->image?>"
                                       alt="gambar" width="100" height="100">
                                    </td>
                                  
                                    <td class="text-uppercase" style="width: 55%;" ><?= $item->title?></td>
                            ...
                            <a href="../../action/galleries/delete.php?id=<?= $item->id ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')">Hapus</a>
                        <?php endif; ?>
                                </td>
                                </tr>
                               <?php
