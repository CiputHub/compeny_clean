            ...
            <div class="card-body">
                ...
                <form action="../../action/teachers/update.php?id=<?= $teachers->id?>" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="teachers_name" class="form-control" id="teachers_nameInput" placeholder="Masukan judul..." required value="<?=$teachers->teachers_name?>" disabled>
                    </div>
                    <div class="mb-3">
                        <h6>Gambar</h6>
                        <img class="w-25" src="../../../storages/teachers/<?=$teachers->teachers_photo?>" alt="teachers_photo">
                        <label for="teachers_photoInput" class="form-label" disabled></label>
                    </div>
                    
                    <div class="mb-3">
                        <label for="teachers_majorInput" class="form-label">Jurusan</label>
                        <textarea name="teachers_major" id="teachers_major" class="form-control" disabled placeholder="Masukan deskripsi..." rows="5"><?=$teachers->teachers_major?></textarea>
                    </div>
                    
                      <div class="mb-3">
                    <label for="gender" class="form-label">Jenis Kelamin</label>
                    <select name="gender" id="gender" class="form-control" required value="<?=$teachers->gender?>" disabled>
