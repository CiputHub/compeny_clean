                            ...
                            <div class="card-body">
                                ...
                                <!-- <form method="GET" class="mb-3 d-flex">
                                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" 
                                        class="form-control me-2" placeholder="Cari judul / Konten...">
                         ...
                         if (mysqli_num_rows($result) > 0):
                            ...
                            ?>
                                <tr>
                                   <td><?= $no++?></td>
                                   <td>
                                       <img src="../../../storages/blogs/<?=$item->image?>"
                                       alt="gambar" width="100" height="100">
                                    </td>
                                    <td class="text-uppercase" style="width: 25%;"><?= $item->title?></td>
                                    
                                    <td class="text-uppercase" style="width: 33%;"><?= mb_strimwidth($item->content, 0, 50, "...") ?></td>
                            ...
                            <a href="../../action/blog/delete.php?id=<?= $item->id ?>" class="btn btn-danger" onclick="return confirm('apakah anda yakin?')">Hapus</a>
                        <?php endif; ?>
                                    </td>
                                </tr>
                           <?php
