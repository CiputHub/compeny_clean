            ...
            <div class="card-body">
                ...
                <form action="../../action/announcements/update.php?id=<?= $announcements->id?>" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="announcements_title" class="form-control" id="announcements_titleInput" placeholder="Masukan Judul..." required value="<?=$announcements->announcements_title?>" disabled>
                    </div>
                    
                    <div class="mb-3">
                        <h6>Gambar</h6>
                        <img class="w-25" src="../../../storages/announcements/<?=$announcements->announcements_image?>" alt="announcements_image">
                        <label for="announcements_imageInput" class="form-label" disabled></label>
                    </div>
                    <div class="mb-3">
                        <label for="announcements_descriptionInput" class="form-label">Deskripsi</label>
                        <textarea name="announcements_description" id="announcements_description" class="form-control" disabled placeholder="Masukan Deskripsi..." rows="5"><?=$announcements->announcements_description?></textarea>
                    </div>
